...
if LRP.timelineData[1][2] then
    ...
    local startTime = 60 * 2 + 3.6 -- This value is the time that the first rotation starts after Overdrive
    local repeatCount = 10 -- Number of repeats after Overdrive
    local interval = 51.1
    ...
    repeatCount = 7 -- Number of repeats after Overdrive
    interval = 51.1
    ...
    -- Add the extra Incinerator cast just before Overdrive
