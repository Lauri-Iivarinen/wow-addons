...
local function BuildTrackLabels()
    ...
    for i, eventData in ipairs(visibleEvents) do
        if eventData.show then
            ...
            local name = eventData.nameOverride or spellInfo and spellInfo.name or "Unknown spell"
            ...
            trackTitle.text:SetText(string.format("|c%s%s|r", isTrackVisible and "ffffffff" or "FF858585", name))
